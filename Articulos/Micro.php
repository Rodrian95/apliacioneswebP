...
if(isset($_SESSION['username'])){
		echo '<script> window.location="Micro2.php";</script>';
}
  ?>
...
<Div class="container-fluid">
    ...
    <h1>Microcontrolador PIC 18F4550</h1>
    </head>
    <body>
        <div class="divrelative">
        <img src="../Images/PIC.jpg" width="400" height="400">
...
<iframe  height="400" width="1100" src="https://www.microchip.com/wwwproducts/en/PIC18F4550">
</iframe>
</div>
    </body>
