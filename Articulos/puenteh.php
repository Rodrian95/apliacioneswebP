...
if(isset($_SESSION['username'])){
		echo '<script> window.location="puenteh2.php";</script>';
}
  ?>
...
<Div class="container-fluid">
    ...
    <title>Interfaz puente h</title>
    <h1>Interfaz puente h</h1>
    </head>
    <body>
        <div class="divrelative">
        <img src="../Images/puenteh.jpg" width="400" height="400">
...
<div class="Frame">
<iframe  height="400" width="1100" src="http://www.ti.com/lit/ds/symlink/l293.pdf">
</iframe>
</div>
    </body>
