...
<Div class="container-fluid">
    ...
    <body>
        ...
        <img src="../Images/LCD.jpg" width="400" height="400">
...
<div class="Frame">
<iframe  height="400" width="1100" src="https://www.sparkfun.com/datasheets/LCD/ADM1602K-NSW-FBS-3.3v.pdf">
</iframe>
</div>
    </body>
        ...
        <?php
          ...
          echo '<script> window.location="Lcd.php"; </script>';
        }
        ?>
