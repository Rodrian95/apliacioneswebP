...
if(isset($_SESSION['username'])){
		echo '<script> window.location="servomotor2.php";</script>';
}
  ?>
...
<Div class="container-fluid">
    ...
    <title>Servomotor 180°</title>
    <h1>Servomotor 180°</h1>
    </head>
    <body>
        <div class="divrelative">
        <img src="../Images/servo.jpg" width="400" height="400">
...
<div class="Frame">
<iframe  height="400" width="1100" src="http://www.ee.ic.ac.uk/pcheung/teaching/DE1_EE/stores/sg90_datasheet.pdf">
</iframe>
</div>
    </body>
