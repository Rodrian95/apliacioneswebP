...
if(isset($_SESSION['username'])){
		echo '<script> window.location="llantas2.php";</script>';
}
  ?>
...
<Div class="container-fluid">
    ...
    <title>Llanta para carro velocista</title>
    <h1>Llanta para carro velocista</h1>
    </head>
    <body>
        <div class="divrelative">
        <img src="../Images/llanta.jpg" width="400" height="400">
...
<div class="Frame">
<iframe  height="400" width="1100" src="https://www.pololu.com/file/0J1487/pololu-micro-metal-gearmotors.pdf">
</iframe>
</div>
    </body>
