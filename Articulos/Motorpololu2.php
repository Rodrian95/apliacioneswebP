...
<Div class="container-fluid">
    ...
    <title>Motor Pololu de 1.6</title>
    <h1>Motor Pololu de 1.6</h1>
    </head>
    <body>
        <div class="divrelative">
        <img src="../Images/pololu.jpg" width="400" height="400">
...
<iframe  height="400" width="1100" src="https://www.pololu.com/file/0J1487/pololu-micro-metal-gearmotors.pdf">
        ...
        <?php
          ...
          echo '<script> window.location="Motorpololu.php"; </script>';
        }
        ?>
