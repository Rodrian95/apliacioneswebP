...
if(isset($_SESSION['username'])){
		echo '<script> window.location="relevador2.php";</script>';
}
  ?>
...
<Div class="container-fluid">
    ...
    <title>Relevador 12V</title>
    <h1>Relevador 12V</h1>
    </head>
    <body>
        <div class="divrelative">
        <img src="../Images/rele.png" width="400" height="400">
...
<div class="Frame">
<iframe  height="400" width="1100" src="https://www.hobbytronics.co.uk/datasheets/songle-12v-relay.pdf">
</iframe>
</div>
    </body>
