...
if(isset($_SESSION['username'])){
		echo '<script> window.location="bluetooth2.php";</script>';
}
  ?>
<!DOCTYPE html>
<html lang="es">
...
<Div class="container-fluid">
    ...
    <title>Bluetooth hc 05</title>
    <h1>Bluetooth hc 05</h1>
    </head>
    <body>
        <div class="divrelative">
        <img src="../Images/blue.jpg" width="400" height="400">
...
<div class="Frame">
<iframe  height="400" width="1100" src="http://www.electronica60norte.com/mwfls/pdf/newBluetooth.pdf">
</iframe>
</div>
    </body>
